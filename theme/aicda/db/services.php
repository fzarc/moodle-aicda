...
/**
 * Theme aicda functions and service definitions.
 *
 * @package    theme_aicda
...
$functions = [
    'theme_aicda_fontsize' => [
        'classname' => 'theme_aicda\api\accessibility',
        'classpath' => 'theme_aicda/classes/api/accessibility.php',
        'methodname' => 'fontsize',
        'description' => 'Increase or decrease the site font size.',
        'type' => 'write',
        'ajax' => true,
    ],
    'theme_aicda_sitecolor' => [
        'classname' => 'theme_aicda\api\accessibility',
