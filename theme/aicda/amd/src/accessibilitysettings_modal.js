...
export default class AccessibilityModal extends Modal {
    static TYPE = "theme_aicda/themesettings_modal";
    static TEMPLATE = "theme_aicda/accessibilitysettings_modal";

    constructor(root) {
        super(root);

        let request = Ajax.call([{
            methodname: 'theme_aicda_getthemesettings',
            args: {}
        }]);
    ...
    registerEventListeners() {
        ...
        this.getModal().on(CustomEvents.events.activate, '[data-action="save"]', function() {
            let request = Ajax.call([{
                methodname: 'theme_aicda_savethemesettings',
                args: {
