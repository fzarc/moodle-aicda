...
/**
 * Language file (English) — AICDA theme.
 *
 * @package   theme_aicda
 * @copyright 2026 Fernando Capla (fork); originally 2017 Willian Mano - http://conecti.me
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

defined('MOODLE_INTERNAL') || die();

$string['pluginname'] = 'AICDA';
$string['configtitle'] = 'AICDA';
$string['choosereadme'] = 'AICDA is the custom theme of the AI &amp; Cybersecurity Defense Academy. Forked from Moove, it provides a clean Bootstrap 4 layout tailored to AI and cybersecurity training programmes, with configurable hero slider, brand colours, logos and footer.';
...
$string['privacy:metadata:preference:themeaicdasettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themeaicdasettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themeaicdasettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themeaicdasettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';
