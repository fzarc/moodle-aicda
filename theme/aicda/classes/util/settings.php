...
class settings {
    ...
    public function __construct() {
        $this->theme = theme_config::load('aicda');
    }
    ...
    public function frontpage_slideshow() {
        ...
        $defaultimage = new \moodle_url('/theme/aicda/pix/default_slide.jpg');
    ...
    public function frontpage_marketingboxes() {
        if ($templatecontext['displaymarketingbox'] = $this->displaymarketingbox) {
            ...
            $defaultimage = new \moodle_url('/theme/aicda/pix/default_markegingicon.svg');
