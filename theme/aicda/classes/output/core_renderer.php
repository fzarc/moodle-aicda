...
namespace theme_aicda\output;

use theme_config;
use core\context\course as context_course;
use moodle_url;
use html_writer;
use theme_aicda\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = []) {
        $hasaccessibilitybar = get_user_preferences('themeaicdasettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themeaicdasettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('aicda_additional_header', 'lib.php');
    ...
    public function get_module_footer_callbacks_data() {
        $callbacks = get_plugins_with_function('aicda_module_footer', 'lib.php');
    ...
    public function redirect_message($encodedurl, $message, $delay, $debugdisableredirect,
        ...
        $output .= $this->render_from_template('theme_aicda/loading-overlay', ['encodedurl' => $encodedurl]);
